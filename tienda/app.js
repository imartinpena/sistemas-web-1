...
app.use(express.urlencoded({ extended: true })); // Asegúrate de que esto esté configurado
app.use(express.json());
...
app.use('/userlist', restrict, userlistRouter);
app.use('/passwordGenerator', restrict, passwordGeneratorRouter);
app.use('/orders', restrict, ordersRouter);
app.use('/ordersObject', restrict, ordersObjectRouter)
